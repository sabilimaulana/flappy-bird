...
export class WalletView extends Component {
  ...
  private gameUrl = "https://flappy-bird-phi-woad.vercel.app/";
  ...
  protected onLoad(): void {
    ...
    this.panel.position = v3(
      0,
      -this.panelUITransform.height - size.height * 0.5,
  ...
  public hide() {
    ...
    tween(this.panel)
      .to(0.4, {
        position: v3(
          0,
          -this.panelUITransform.height - size.height,
          this.panel.position.z
        ),
      })
      .start();
  ...
  public okxConnect() {
    this.openLink(
      "https://www.okx.com/download?deeplink=okx://wallet/dapp/url?dappUrl=" +
        encodeURIComponent(this.gameUrl)
    );
  }
